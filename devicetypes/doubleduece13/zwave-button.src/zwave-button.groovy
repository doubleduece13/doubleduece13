/**
 *  Zwave Doorbell Button
 *  based on
 *  Z-Wave Door/Window Sensor by SmartThings
 *
 *  Author: David de Gruyl
 *  Date: 2016-07-01
 *
 *  Based on code from:
 *  Author: Brian Dahlem
...
metadata {
	...
	definition (name: "Z-Wave Button", namespace: "doubleduece13", author: "David de Gruyl") {
		capability "Button"
		capability "Sensor"
		capability "Battery"
	...
	tiles {
		standardTile("button", "device.button", inactiveLabel: false, width: 2, height: 2) {
			state "released", label: "Ding Dong", icon: "st.Home.home30", action: "push"
			state "pushed", label: "Ding Dong", icon: "st.Home.home30", backgroundColor: "#b82121", action: "push"
		}
